...
if(isset($_GET['mode']) && intval($_GET['id']) > 0)
{
	...
	$db->query("DELETE FROM `subscriber` WHERE id = ".$id);
	$_SESSION['msg']	=	'Successfully deleted';
	adheader('subscriber.php');
}
$query	=	$db->query("SELECT * FROM `subscriber` ORDER BY id DESC ");
      ...
      <div class="box">
            ...
            ?>
                ...
                <td><?php echo $count;?></td>
                  ...
                  <td><a onclick="return confirmDelete();" href="<?php echo admin_path?>subscriber.php?mode=delete&id=<?php echo $rows['id'];?>">Delete</a></td>
                </tr>
