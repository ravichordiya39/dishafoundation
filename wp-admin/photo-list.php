...
if(isset($_GET['mode']) && intval($_GET['id']) > 0)
{
  ...
  if($_GET['img'] != '')
  {
	...
	adheader('photo-list.php');
}
$query	=	$db->query("SELECT * FROM `images` ORDER BY id DESC limit 50 ");
...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Photos</a></li>
    ...
    <section class="content container-fluid">
      <div class="box">
            <div class="box-header">
              <h3 class="box-title">Photos List</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            <?php
		...
		{$count++;
            ?>
                ...
                <td><?php echo $count;?></td>
                  <td><img src="<?php echo base_path?>post_images/<?php echo $rows['file_name'];?>" width="300"></td>
                  <td><a onclick="return confirmDelete();" href="<?php echo admin_path?>photo-list.php?mode=delete&id=<?php echo $rows['id'];?>">Delete</a></td>
                </tr>
                <?php } 
			   } ?>
                </tbody>
